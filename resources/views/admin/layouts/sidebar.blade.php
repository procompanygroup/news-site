			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">سياسة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">اقتصاد</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">رياضة</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}">قائمة المستخدمين</a></li>
